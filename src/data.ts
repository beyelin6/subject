...
export const SUBJECT_DIMENSIONS: Record<string, Record<string, Dimension[]>> = {
  ...
  social: {
    ...
    "3": [
      { id: "soc_g3_family_school", name: "🏠 家庭生活、班級自治與同儕人際探索（上學期第一至六單元）", labels: { high: "🟢 深刻理解家庭組成與倫理運作，精通校園安全與班級自治，與同儕平等尊重互動極佳", mid: "🟡 理解家庭功能、班級自治活動大意，日常能安全守規並與同學友善合作相處", low: "🔴 對家庭倫理責任概念較陌生，班級自治或同儕相處人際界線常需輔導" } },
      { id: "soc_g3_local_community", name: "🗺️ 居住地方設施居民、人人消費與家鄉地名故事（下學期第一至六單元）", labels: { high: "🟢 熟悉居住地環境設施與居民活動，消費觀念聰明且深諳地方地名故事與情操", mid: "🟡 知道居住地方的基本設施與居民作息，具備基礎消費常識與地名探索意願", low: "🔴 對居住地方之地理環境或消費停看聽知能不足，對地名由來與故事不解" } },
      { id: "social_attitude", name: "💡 社會課堂探索發言、學習手札整理與團隊配合度", labels: { high: "🟢 社會課提問與民主思辨時觀點新穎卓越，學習手札整理工整，且團隊走讀探究表現極佳", mid: "🟡 按時遞交社會練習手札及社會習作，能配合組員完成社會科踏查報告", low: "🔴 上社會課時常不自覺分心，社會學習本與課堂發表常缺漏、遲延繳交" } }
    ],
    "4": [
      { id: "soc_g4_nature_culture", name: "🏞️ 家鄉地形氣候、傳統住屋器物、信仰與歲時節慶（上學期第一至四單元）", labels: { high: "🟢 精通家鄉地理位置、地形與水資源分配，對傳統住屋、民俗信仰與中西節慶變遷分析極佳", mid: "🟡 能讀懂家鄉氣候與地形特色，大致說出老街信仰及歲時節慶由來與作息差別", low: "🔴 對家鄉地理地貌較無概念，不易分清傳統器物、民俗信仰或生活作息變遷" } },
      { id: "soc_g4_industry_traffic", name: "💼 家鄉產業人口分布、交通運輸與未來永續發展（下學期第一至四單元）", labels: { high: "🟢 熟知家鄉農林漁牧及工商業演進，精確解構人口變化、交通與訊息傳遞對永續發展之關係", mid: "🟡 理解家鄉三大產業類型與人口分布，配合做交通運輸、特產與家鄉問題探索", low: "🔴 對家鄉產業與人口變異無感，交通運輸及訊息變遷與永續家鄉的概念模糊" } },
      { id: "social_attitude", name: "💡 社會課堂探索發言、學習手札整理與團隊配合度", labels: { high: "🟢 社會課提問與民主思辨時觀點新穎卓越，學習手札整理工整，且團隊走讀探究表現極佳", mid: "🟡 按時遞交社會練習手札及社會習作，能配合組員完成社會科踏查報告", low: "🔴 上社會課時常不自覺分心，社會學習本與課堂發表常缺漏、遲延繳交" } }
    ],
    "5": [
      { id: "soc_g5_taiwan_geography_early_history", name: "🌍 臺灣地理經緯位置、社會規範與法律、史前文化與大航海時代（上學期第一至四單元）", labels: { high: "🟢 臺灣位置與地形氣候地理知識卓越，熟知社會規範法律，史前原民與荷西鄭大航海脈絡極清", mid: "🟡 能指出臺灣經緯氣候特性、法律規範大意，對史前與大航海時期的外來經營有基礎理解", low: "🔴 臺灣經緯讀圖與地形常指錯，對社會規範概念或大航海時期的經營歷史時空錯亂" } },
      { id: "soc_g5_taiwan_modern_history_law", name: "📜 臺灣清領日治發展、民主政治與經濟、法律常識與少年的權益（下學期第一至五單元）", labels: { high: "🟢 精通清領開墾開港、日治殖民與臺灣人抗爭史，熟知戰後民主經濟發展與兒少法治防犯罪警覺", mid: "🟡 知道清領與日治重大史實，能理解近代民主化進程並具備基本的少年法律防護常識", low: "🔴 清領與日治歷史變遷時空搞混，民法常識或憲法、兒少生活法律警覺與維護上極模糊" } },
      { id: "social_attitude", name: "💡 社會課堂探索發言、學習手札整理與團隊配合度", labels: { high: "🟢 社會課提問與民主思辨時觀點新穎卓越，學習手札整理工整，且團隊走讀探究表現極佳", mid: "🟡 按時遞交社會練習手札及社會習作，能配合組員完成社會科踏查報告", low: "🔴 上社會課時常不自覺分心，社會學習本與課堂發表常缺漏、遲延繳交" } }
    ],
    "6": [
      { id: "soc_g6_taiwan_democracy_development", name: "🇹🇼 臺灣民主發展與權利義務、社會變遷與族群交流、科技島與城鄉永續（上學期第一至四單元）", labels: { high: "🟢 民主政體權利義務思辨卓越，對社會變遷、跨族群文化與都鄉發展永續關係解析極為精闢", mid: "🟡 了解臺灣民主歷程與權利義務，配合進行戰後經濟與高科技島、城鄉互動大意之探究", low: "🔴 對民主制度或公民權利義務認知薄弱，城鄉都鄉永續和科技島衝擊等課題常抓不到重點" } },
      { id: "soc_g6_global_geography_history_sdgs", name: "🌐 世界地理環境、近代文明古國、科技反思、國際參與與永續 SDGs（下學期第一至五單元）", labels: { high: "🟢 熟知五大洲三大洋環境與近代世界史思潮，對科技倫理反思深刻，具國際人道關懷與落實 SDGs 行動", mid: "🟡 能指認世界地理分布，知道世界歷史重要事件，配合關心科技發展、國際組織與環境永續議題", low: "🔴 全球地理環境或世界古文明發展理解不清，對全球氣候暖化、國際人權或 SDGs 的責任感薄弱" } },
      { id: "social_attitude", name: "💡 社會課堂探索發言、學習手札整理與團隊配合度", labels: { high: "🟢 社會課提問與民主思辨時觀點新穎卓越，學習手札整理工整，且團隊走讀探究表現極佳", mid: "🟡 按時遞交社會練習手札及社會習作，能配合組員完成社會科踏查報告", low: "🔴 上社會課時常不自覺分心，社會學習本與課堂發表常缺漏、遲延繳交" } }
    ]
  },
  english: {
  ...
  fineart: {
    ...
    "3": [
      { id: "art_technique", name: "🎨 黏土立體造型與紙刻版畫創作（造型表現）", labels: { high: "🟢 立體比例拿捏精緻，刻版印製細膩", mid: "🟡 完成黏土造型並配合印出清晰版畫", low: "🔴 黏土塑形比例稍失衡，版畫易有污漬" } },
      { id: "art_appreciation", name: "👁️ 鄉土民俗工藝與陶藝之美賞析（審美鑑賞）", labels: { high: "🟢 深刻賞析傳統陶藝，心得體悟深刻", mid: "🟡 能辨認民俗工藝特色並表達喜好", low: "🔴 對民俗藝術特點認知模糊，表達被動" } },
      { id: "art_attitude", name: "🧹 安全使用美勞工具與常規自律（學習態度）", labels: { high: "🟢 正確並安全操作剪刀雕刻刀，自律高", mid: "🟡 能依安全守則進行勞作，專注度好", low: "🔴 使用工具時易分心，需常提醒安全" } }
    ],
    "4": [
      { id: "art_technique", name: "🎨 剪紙窗花對稱與水彩光影繪畫（色彩光影）", labels: { high: "🟢 對稱剪紙圖樣精緻，光影渲染力強", mid: "🟡 剪出完整對稱窗花，水彩著色有明暗", low: "🔴 剪紙結構容易剪斷，著色明暗不顯" } },
      { id: "art_appreciation", name: "👁️ 傳統老街宗教建築美感欣賞（審美鑑賞）", labels: { high: "🟢 熱忱探索廟宇與老街裝飾之美，見解好", mid: "🟡 知道老街與宗教建築之歷史美感特色", low: "🔴 對家鄉老街與建築雕刻美感體會較淺" } },
      { id: "art_attitude", name: "🧹 特定美勞材料備齊與作品分享（學習態度）", labels: { high: "🟢 準時帶齊特定材料，發表作品大方有條理", mid: "🟡 可自主準備美勞材料，能配合展示作品", low: "🔴 美術課材料常遺漏，發表時退縮害羞" } }
    ],
    "5": [
      { id: "art_technique", name: "🎨 透視圖繪製與新國風水墨創作（進階技法）", labels: { high: "🟢 透視空間感精確，水墨渲染乾濕得宜", mid: "🟡 繪出單點透視空間，掌握水墨基本皴法", low: "🔴 畫面缺乏空間立體感，水墨水分過度" } },
      { id: "art_appreciation", name: "👁️ 中西藝術名作與自然生態美學（多元鑑賞）", labels: { high: "🟢 多視角賞析名作，對自然美感省思深刻", mid: "🟡 能口述名作風格，欣賞自然界對稱之美", low: "🔴 藝術名作賞析流於表面，美感聯想單一" } },
      { id: "art_attitude", name: "🧹 團體美展合作與高級媒材保養（學習態度）", labels: { high: "🟢 小組壁畫分工融洽，工具保養精細良好", mid: "🟡 能與同學合作大圖創作，愛護公共用具", low: "🔴 分組合創時參與度低，易荒廢或折損畫筆" } }
    ],
    "6": [
      { id: "art_technique", name: "🎨 畢業季主題設計與複合媒材創作（畢業專案）", labels: { high: "🟢 畢業作品結構精妙，複合素材搭配大膽", mid: "🟡 融入主題完成紀念卡，拼接美感成熟", low: "🔴 作品題材較為單一，美工拼接稍顯凌亂" } },
      { id: "art_appreciation", name: "👁️ 數位影像海報與生活設計美學（當代審美）", labels: { high: "🟢 解析數位排版美學卓越，觀察生活設計深", mid: "🟡 能利用數位工具排版，理解實用美學大意", low: "🔴 對數位排版美感無自覺，生活審美較模糊" } },
      { id: "art_attitude", name: "🧹 畢業美展佈置與用具整理自律（自主負責）", labels: { high: "🟢 自主分工佈展盡責，工具收拾極有紀律", mid: "🟡 配合美展場地清理，妥善整理美術用具", low: "🔴 佈展分工配合被動，個人美術垃圾常亂丟" } }
    ]
  },
  music: {
    "1": [
...
export const FRAGMENTS: Record<string, any> = {
  ...
  social: {
    ...
    soc_g3_family_school: {
      high: "深刻理解家庭組成與倫理意義，校園安全守則、班級自治活動執行力優異，同儕相處人際界線融洽",
      mid: "理解基本家庭倫理，能遵守校園作息安全與班級生活公約，與同學同儕進行和諧互動",
      low: "對家庭應盡本分概念一般，日常班級內自治常規或人際衝突處理上仍需師長指引與叮嚀"
    },
    soc_g3_local_community: {
      high: "熟悉居住地方環境地圖、公共設施功能，具備卓越理財與聰明消費概念，熱切關懷地方故事承傳",
      mid: "大致指認居住地方生活各行各業特色與民生公共機關，懂得垃圾分類與基本消費金錢概念",
      low: "對家鄉居住地方的機構與方向感模糊，聰明消費理財概念偏弱，地名由來背景不清楚"
    },
    soc_g4_nature_culture: {
      high: "地圖讀圖及比例尺測量精細，精通家鄉地形氣候特性，且對傳統住屋、老街宗教與節慶變遷探查深入",
      mid: "能配合讀圖並說出家鄉基本地貌與氣候，明白傳統老街建築、民俗活動與作息之演進差別",
      low: "地圖比例尺及圖例識讀緩慢，對於傳統住屋、民俗老街歷史或傳統與現代節慶變革之因由理解模糊"
    },
    soc_g4_industry_traffic: {
      high: "深明家鄉農林漁牧與工商業古今脈絡，分析人口老化變遷、交通運輸工具變革與城鄉永續發展關係卓著",
      mid: "知道家鄉的主要產業特產，理解大眾運輸網絡及訊息傳遞之便利性，配合參與爱我家鄉計畫",
      low: "對本鄉本土產業結構或地名發展不熟悉，交通工具變遷及人口發展等永續家鄉議題理解零碎"
    },
    soc_g5_taiwan_geography_early_history: {
      high: "臺灣地理定位、河川水文氣候等空間概念極熟，熟知社會規範法律之關聯，早期史前、原民與大航海荷西鄭氏歷史通透",
      mid: "知道臺灣經緯度及地形氣候，明白基本的社會生活規範，大致能陳述臺灣早期原住民族與大航海時期的開發背景",
      low: "對臺灣地形、水資源或氣候之關聯性分析吃力，史前文化、原民习俗與荷西鄭氏時期的時空定位常混淆"
    },
    soc_g5_taiwan_modern_history_law: {
      high: "清領墾荒開港通商、日治殖民近代建設及抗爭史觀清徹，精熟戰後臺灣民主經濟轉型與少年法治和兒少權益防護",
      mid: "知道清領時期土地開發、日治時期殖民現代化建設，理解基本憲法法律常識並做好日常兒少自我人道權益防護",
      low: "大航海、清領日治等歷史概念混淆，對民主法治歷程生硬，對少年法治、預防犯罪等常識較為遲滯"
    },
    soc_g6_taiwan_democracy_development: {
      high: "民主憲政政府運作、人民權利與義務之思辨觀點精闢，客觀論述社會變遷跨族群文化，並掌握都鄉永續和工業科技衝擊",
      mid: "理解政府與人民基本關係，知道臺灣民主政治發展歷程、社會變遷與都市化、工業化變異對生活的普遍好壞",
      low: "對人民基本權利與義務認知模糊，難以理解都市與鄉村之均衡互補，對城鄉發展與科技島社會變異感到茫然"
    },
    soc_g6_global_geography_history_sdgs: {
      high: "精熟世界五大洲三大洋地理人口特點與近代世界歷史，反思高新技術與資訊倫理，熱心實踐聯合國 SDGs 與地球公民責任",
      mid: "認識大洲與世界歷史大意，知道資訊倫理網路安全，能理解氣候暖化與貧富差距等全球挑戰並配合落實綠色行動",
      low: "對世界地理分布方位與世界史發展時序概念模糊，對聯合國 SDGs 倡議、國際關懷與綠色公民實踐上極為敷衍"
    },
    social_attitude: {
